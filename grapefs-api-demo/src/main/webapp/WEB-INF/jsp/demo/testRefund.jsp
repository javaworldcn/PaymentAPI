...
<div class="pageContent">
	<form:form method="post" modelAttribute="model"
		action="${pageContext.request.contextPath}/demo/refund"
		...
		<input type="hidden" name="signType" value="MD5"/>
			<table>
				<tr>
					<td>请求地址</td>
					<td><input type="text" name="apiUrl"  value="http://dev.grapefs.com/gpay/refund"  size="50"/></td>
				</tr>
				<tr>
					<td>平台商户号</td>
				...
				<tr>
					<td>退款订单号</td>
					<td><input type="text" name="refundOrderNo" size="50"/></td>
				</tr>
				<tr>
					<td>原交易订单号</td>
