...
<div class="pageContent">
	<form method="post"
		action="${pageContext.request.contextPath}/demo/openMerchantProduct"
		<div class="pageFormContent" layoutH="157">
			<table>
				<tr>
					<td>1、商户开通产品api地址</td>
					<td><input type="text" name="openMerchantProductUrl" value="http://localhost:8080/mgmt/openMerchantProduct"  size="50"/></td>
				</tr>
				<tr>
					<td>2、agentKey</td>
