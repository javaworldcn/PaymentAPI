...
<div class="pageContent">
	<form:form method="post" modelAttribute="model" 
		action="${pageContext.request.contextPath}/business/updateAgentSettBatchStatusNow"
		...
		<input type="hidden" name="signType" value="MD5"/>
			<table>
				<tr>
					...
					<td><input type="text" name="interfaceAddr" value="/mgmt/settByBatchNo"  size="30"/></td>
				</tr>
