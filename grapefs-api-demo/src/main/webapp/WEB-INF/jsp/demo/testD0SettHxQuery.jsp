...
<div class="pageContent">
	<form:form method="post" modelAttribute="model"
		action="${pageContext.request.contextPath}/demo/D0SettHxQuery"
			...
			<table>
				<tr>
					...
					<td><input type="text" name="apiUrl"
						value="http://dev.grapefs.com/gpay/queryWithdrawInfo"
						size="50" /></td>
				</tr>
				<tr>
					<td>2、平台商户号</td>
				...
				<tr>
					<td>4、提现批次订单号</td>
					<td><input type="text" name="withdrawBatchNo" size="50" /></td>
				</tr>
			</table>
