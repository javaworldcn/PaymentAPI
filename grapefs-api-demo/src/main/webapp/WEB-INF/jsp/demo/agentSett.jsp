...
<div class="pageContent">
	<form:form method="post" modelAttribute="model" 
		action="${pageContext.request.contextPath}/business/agentSettNow"
		...
		<input type="hidden" name="signType" value="MD5"/>
			<table>
				<tr>
					...
					<td><input type="text" name="interfaceAddr" value="/mgmt/agentSettle"  size="50"/></td>
				</tr>
			...
			<ul>
				<li><div class="buttonActive">
						<div class="buttonContent">
							<button type="submit">点击这里开始结算</button>
						</div>
					</div></li>
				<!-- <li><div class="button">
						<div class="buttonContent">
