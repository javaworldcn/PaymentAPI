...
<div class="pageContent">
	<form method="post"
		action="${pageContext.request.contextPath}/demo/openMerchant"
		<div class="pageFormContent" layoutH="157">
			<table>
				<tr>
					<td>1、报备商户API地址</td>
					<td><input type="text" name="reportMerchantUrl" value="http://localhost:8080/mgmt/createMerchantInfo"  size="50"/></td>
				</tr>
				<tr>
					<td>2、agentKey</td>
