...
<div class="pageContent">
	<form:form method="post" modelAttribute="model"
		action="${pageContext.request.contextPath}/demo/D0SettHxListByMerch"
			...
			<table>
				<tr>
					...
					<td><input type="text" name="apiUrl"
						value="http://test.grapefs.com/gpay/xmhx/withdrawByMerch" size="50" /></td>
				</tr>
				<tr>
					<td>2、平台商户号</td>
			...
			<ul>
				<li><div class="buttonActive">
						<div class="buttonContent">
							<button type="submit">提现该商户目前所有交易</button>
						</div>
					</div></li>
				<!-- <li><div class="button">
						<div class="buttonContent">
