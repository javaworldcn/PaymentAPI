...
<title>按结算流水号更新单个代理商打款状态</title>
<div class="pageContent">
	<form:form method="post" modelAttribute="model" 
		action="${pageContext.request.contextPath}/business/updateAgentSettStatusNow"
		...
		<input type="hidden" name="signType" value="MD5"/>
			<table>
				<tr>
					...
					<td><input type="text" name="interfaceAddr" value="/mgmt/settBySettTrxNo"  size="50"/></td>
				</tr>
				
				<tr>
					<td>2、结算流水号</td>
					<td><input type="text" name="settTrxNos"   size="50" /></td>
				</tr>
				<tr>
					<td>3、密钥</td>
			...
			<ul>
				<li><div class="buttonActive">
						<div class="buttonContent">
							<button type="submit">点击这里更新代理商打款结算状态</button>
						</div>
					</div></li>
				<!-- <li><div class="button">
						<div class="buttonContent">
